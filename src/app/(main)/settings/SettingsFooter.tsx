...
export default function SettingsFooter() {
  ...
  return (
    <div className="mx-auto mb-8 flex w-full max-w-4xl flex-col items-center gap-2 px-2 md:flex-row md:items-center md:gap-0 md:px-6">
      <div className="hidden grow md:block" />
      <div className="flex items-center">
        <p className="pr-2 text-center text-sm text-yellow-400 md:text-left">
        ...
        <a
          ...
          className="shrink-0 transform duration-500 hover:scale-150 hover:rotate-6"
        >
      ...
      <div className="flex items-center">
        <p className="pr-2 text-center text-sm text-yellow-400 md:pl-4 md:text-left">
